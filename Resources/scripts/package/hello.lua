...
local function main()
    ...
    -- HelloDemo = HelloDemo or {}
    -- ccb["HelloDemo"] = HelloDemo

    -- HelloDemo.onClick = function ()
    --     cclog("OnClickButtonClicked")
    -- end

    -- local function HelloCCBTestMainLayer()
    --     local proxy = CCBProxy:create()
    --     local node = CCBuilderReaderLoad("/ccb/ccbi/HelloDemo.ccbi",proxy,true,"HelloDemo")
    ...
    local function createLayerFarm()
        ...
        bg:setPosition(origin.x + visibleSize.width / 2 -50, origin.y + visibleSize.height / 2)
